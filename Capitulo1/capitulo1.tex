 ...
 Si la velocidad es cero y no hay reacción química, se obtiene:
  \begin{equation}
 	...
 	Frecuencia de colisiones:
        ...
        \begin{figure}[H]
\raggedright
\includegraphics[width=0.7\linewidth]{fig-1-1.jpg}
 \caption{Figura 1.1. Transferencia molecular de A del plano (y-a) al plano (y)}
\label{fig:1.1}
\end{figure}
...
\begin{figure}[H]
\raggedright
\includegraphics[width=0.7\linewidth]{fig-1-51.jpg}
 \caption{Figura 1.51 Autodifusión reducida como fnción de la temperatura reducida}
\label{fig:1.51}
\end{figure}
